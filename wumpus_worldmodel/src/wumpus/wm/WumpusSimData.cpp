...

{
    ...
    this->actionResponseBuffer = new supplementary::InfoBuffer<wumpus::model::communication::ActionResponsePerception>(
            (*sc)["WumpusWorldModel"]->get<int>("Data.ActionResponse.BufferLength", NULL));
...
*/
void WumpusSimData::processInitialPoseResponse(wumpus::model::communication::InitialPosePerception initialPoseResponse)
{
...
void WumpusSimData::processActionResponse(wumpus::model::communication::ActionResponsePerception actionResponse)
{
    ...
    auto actionResponseInfo = std::make_shared<supplementary::InformationElement<wumpus::model::communication::ActionResponsePerception>>(
            actionResponse, wm->getTime(), this->actionResponseValidityDuration, 1.0);
...
void WumpusSimData::processAgentPerception(wumpus::model::communication::AgentPerceptions agentPerception)
{
    ...
    agent->updateObjective(agentPerception.objective);
...
const supplementary::InfoBuffer<wumpus::model::communication::ActionResponsePerception>* WumpusSimData::getActionResponseBuffer()
{
